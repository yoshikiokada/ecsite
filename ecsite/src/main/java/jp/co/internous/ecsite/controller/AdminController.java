...
public class AdminController {
	...
	public String welcome(LoginForm form, Model m) {
		List<User> users = userRepos.findByUserNameAndPassword(form.getUserName(), form.getPasswoｒｄ());
	...
	public String goodsMst(LoginForm form, Model m) {
		...
		m.addAttribute("password", form.getPasswoｒｄ());
	...
	public String addGoods(GoodsForm goodsForm, LoginForm loginForm, Model m) {
		...
		m.addAttribute("password", loginForm.getPasswoｒｄ());
